...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        if (mAuthTask != null) {
            // IT SHOULD JUST CALL MAIN ACTIVITY
            return;
        }
                                ...
                                dataService.getmAuth().signInWithEmailAndPassword(mEmail, mPassword).addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                                    ...
                                    public void onComplete(@NonNull Task<AuthResult> task) {
                                        if (!task.isSuccessful()) {
                                            ...
                                            Toast.makeText(LoginActivity.this, getString(R.string.emai_password_incorrect),
    ...
    private void handleFacebookAccessToken(AccessToken token) {
        ...
        DataService.getInstance().getmAuth().signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            FirebaseUser user =  DataService.getInstance().getmAuth().getCurrentUser();
                            updateUI(user);
                        } else {
    ...
    public void onStart() {
        ...
        FirebaseUser currentUser = DataService.getInstance().getmAuth().getCurrentUser();
